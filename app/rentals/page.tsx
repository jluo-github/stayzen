...
import { fetchRentalsAction, deleteRentalAction } from "@/utils/actions";
...
const RentalsPage = async () => {
  const rentals = await fetchRentalsAction();
  if (rentals.length === 0) {
    return (
      <EmptyList
        heading='No rentals to display.'
        message='Please create a rental.'
      />
    );
  }
  ...
  return (
    <div className='mt-12'>
      <h3 className='my-4'>Active Properties: {rentals.length}</h3>
      <Table>
